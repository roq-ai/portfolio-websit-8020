...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Visitor'];
  const customerRoles: string[] = [];
  const tenantRoles: string[] = ['Visitor', 'Blog Subscriber', 'Project Viewer'];
  const addOns: string[] = ['file'];
  const applicationName = `Portfolio Website`;
  const tenantName = `Job Hire`;
